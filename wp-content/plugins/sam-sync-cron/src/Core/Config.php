...
use Snapshot\SamSync\Core\Exceptions\ConfigValueMissing;
...
class Config
{
    ...
    public const SAM_API_KEY = 'SAM_API_KEY';
    ...
    public static function init(string $validationType)
    {
        ...
        if (!static::getApiKey()) {
            throw new ConfigValueMissing(static::SAM_API_KEY);
        }
    }
    ...
    {
        return static::get(static::SAM_API_KEY);
    }
